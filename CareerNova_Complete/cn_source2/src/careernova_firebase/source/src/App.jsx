...
const DashSection = ({
  ...
  const completion =
    user?.name && user?.email
      ? Math.min(68 + (applications.length > 0 ? 5 : 0) + (savedJobs.length > 0 ? 3 : 0), 100)
      : 50;
  const stats = [
    {
      label: "Applications",
    ...
    savedProfile?.experience || [
      {
        ...
        company: "Tech Corp",
        period: "2022 – Present",
        desc: "Led frontend development for enterprise SaaS platform.",
      },
      {
        role: "Junior Developer",
        company: "Startup XYZ",
        period: "2020 – 2022",
        desc: "Built React components and REST API integrations.",
      },
    ]
  );
  ...
  return (
    <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div>
            ...
            <small style={{ color: "var(--text-muted)", display: "block", marginTop: 5 }}>
              Changing your email requires your current password &amp; verification code
            </small>
          </div>
          <div>
      ...
      <div className="card" style={{ padding: 22, marginBottom: 16 }}>
        ...
        >
          <span>
            {notifRows.filter((r) => notif[r.key]).length} of {notifRows.length} notifications enabled
          </span>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <ToggleSwitch
                ...
                onChange={(v) =>
                  setPrivacy((p) => ({ ...p, profile: v ? "public" : "private" }))
                }
              />
            </div>
          </div>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <ToggleSwitch
                ...
                onChange={(v) =>
                  setPrivacy((p) => ({ ...p, resume: v ? "public" : "private" }))
                }
              />
            </div>
          </div>
        ...
        <>
          ...
          >
            ...
            >
              ...
              >
                {emailChangeStep === "password" ? "Change Email" : "Verify New Email"}
              </div>
              <button
                style={{
                  background: "none",
...
const AuthPage = ({ mode, setPage, setUser }) => {
  ...
  const handleSignupSubmit = async () => {
    ...
    try {
      ...
      setUser({ name: user.name, email: user.email, role: form.role === "employer" ? "Employer" : "Job Seeker" });
  ...
  // ── Sign-up: step 2 – verify OTP on server, then save account ──────────────
